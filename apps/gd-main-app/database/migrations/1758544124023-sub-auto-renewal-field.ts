...
export class SubAutoRenewalField1758544124023 implements MigrationInterface {
  name = 'SubAutoRenewalField1758544124023';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_subscription_entity" ADD "is_auto_renewal" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."payment_info_plan_type_enum" RENAME TO "payment_info_plan_type_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."payment_info_plan_type_enum" AS ENUM('monthly', '3month', '6month', 'yearly')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_subscription_entity_plan_type_enum" AS ENUM('monthly', '3month', '6month', 'yearly')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_subscription_entity_plan_type_enum_old" AS ENUM('monthly', '3month', '6month')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payment_info_plan_type_enum_old" AS ENUM('monthly', '3month', '6month')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_subscription_entity" DROP COLUMN "is_auto_renewal"`,
    );
  }
}
