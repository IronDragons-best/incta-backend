...
export class CascadeUserSave1757517792375 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_info_status_enum" AS ENUM('processing', 'succeeded', 'failed', 'refunded', 'cancelled')`);
        await queryRunner.query(`ALTER TABLE "payment_info" ADD "status" "public"."payment_info_status_enum" NOT NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_subscription_entity_status_enum" AS ENUM('processing', 'succeeded', 'failed', 'refunded', 'cancelled')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_subscription_entity_status_enum_old" AS ENUM('pending', 'active', 'canceled', 'expired', 'past_due')`);
