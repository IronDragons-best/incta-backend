...
export class PlantypeUpdate1757788698170 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_subscription_entity_status_enum" AS ENUM('pending', 'active', 'expired', 'cancelled', 'past_due', 'failed')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_subscription_entity_status_enum_old" AS ENUM('processing', 'succeeded', 'failed', 'refunded', 'cancelled')`);
