...
@Injectable()
export class PaymentSuccessNotificationListener extends PaymentBaseRabbitListener {
  constructor(
    ...
    this.logger.setContext('PaymentSuccessNotificationListener');
  }
  ...
  handlePaymentSuccess(event: PaymentSuccessEvent) {
    ...
    this.sendMessage('payment.success.notification', record);
  }
}
